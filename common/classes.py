...
"not recognised" placeholder (NR) are deliberately EXCLUDED — see CLAUDE.md
§2.1 for the reasoning (crop is not a detection target here; NR is a non-class;
both are dropped to match the published protocol and remove a cross-season
annotation inconsistency, since TOMATO_2/2022 never labels the crop).
...
# voc_to_yolo skips boxes with these names. Documented in CLAUDE.md §2.1.
