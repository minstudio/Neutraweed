"""Annotation-reduction experiment datasets (Stage D).
...
2022 domain information the composites carry, not merely image count. Always
run the matched-size control.
